...
fprintf(fp,"  )\n");
    ...
    fprintf(fp,"  (module head:pin (layer F.Cu) (tedit 0) (tstamp 5EAFD035)\n");
...
//    fprintf(fp,"\n");
//    fprintf(fp,"    (fp_text reference \"\" (at 0 -2.4) (layer F.SilkS) (effects (font (size 0.5 0.5) (thickness 0.01)))  )\n");
//    fprintf(fp,"    (fp_text value \"\" (at 0 -3.1) (layer F.Fab) (effects (font (size 0.5 0.5) (thickness 0.01)))  )\n");
    fprintf(fp,"    (pad x thru_hole oval (at 0 0) (size 1.8 1.8) (drill 1.016) (layers *.Cu *.Mask F.SilkS))\n");
    fprintf(fp,"  )\n");
    ...
    fprintf(fp,"(gr_text G (at %10.5lf %10.5lf 270) (layer F.SilkS)(effects (font (size 1 1) (thickness 0.15))))\n",ax-3.0,ay-2.54);
    fprintf(fp,"(gr_text V (at %10.5lf %10.5lf 270) (layer F.SilkS)(effects (font (size 1 1) (thickness 0.15))))\n",ax-3.0,ay+0.00);
    fprintf(fp,"(gr_text I (at %10.5lf %10.5lf 270) (layer F.SilkS)(effects (font (size 1 1) (thickness 0.15))))\n",ax-3.0,ay+2.54);

    fprintf(fp,"  (module head:er (layer F.Cu) (tedit 0) (tstamp 5EAFD035)\n");
...
//    fprintf(fp,"    (fp_text value \"\" (at 0 -3.1) (layer F.Fab) (effects (font (size 0.5 0.5) (thickness 0.01)))  )\n");
    ...
    fprintf(fp,"    (fp_line (start -6 2.54) (end 6 2.54) (layer F.CrtYd) (width 0.01))\n");
    fprintf(fp,"    (pad 1 thru_hole oval (at 0 -2.54) (size 1.8 1.8) (drill 1.016) (layers *.Cu *.Mask F.SilkS))\n");
    fprintf(fp,"    (pad 2 thru_hole oval (at 0 0) (size 1.8 1.8) (drill 1.016) (layers *.Cu *.Mask F.SilkS))\n");
    fprintf(fp,"    (pad 3 thru_hole oval (at 0 2.54) (size 1.8 1.8) (drill 1.016) (layers *.Cu *.Mask F.SilkS))\n");
    fprintf(fp,"  )\n");
    ...
    for(ra=0;ra<DIVISIONS;ra+=2)
    {
        ...
        //fprintf(fp,"    (attr smd)\n");
        fprintf(fp,"    (pad G smd rect (at -0.8 0 %10.5lf) (size 0.8 0.8) (layers F.Cu F.Paste F.Mask))\n",xangle[ra]);
        fprintf(fp,"    (pad V smd rect (at +0.8 0 %10.5lf) (size 0.8 0.8) (layers F.Cu F.Paste F.Mask))\n",xangle[ra]);
        fprintf(fp,"  )\n");

        fprintf(fp,"(module 00_my_modules:X (layer B.Cu) (tedit 5415CC62) (tstamp 5EA86CD9)\n");
        fprintf(fp,"    (at  %10.5lf %10.5lf %10.5lf)\n",150+xax[ra]*RING_BASE,100+xay[ra]*RING_BASE,xangle[ra]);
        ...
        fprintf(fp,"    (fp_line (start -2.65 0.5) (end -2.65 -0.5) (layer B.SilkS) (width 0.1))\n");
        ...
        fprintf(fp,"    (pad VCC smd rect (at  2.7  1.65 %10.5lf) (size 2 0.9) (layers B.Cu B.Paste B.Mask))\n",xangle[ra]);
        fprintf(fp,"    (pad OUT smd rect (at  2.7 -1.65 %10.5lf) (size 2 0.9) (layers B.Cu B.Paste B.Mask))\n",xangle[ra]);
        fprintf(fp,"    (pad GND smd rect (at -2.7 -1.65 %10.5lf) (size 2 0.9) (layers B.Cu B.Paste B.Mask))\n",xangle[ra]);
        fprintf(fp,"    (pad  IN smd rect (at -2.7  1.65 %10.5lf) (size 2 0.9) (layers B.Cu B.Paste B.Mask))\n",xangle[ra]);
        fprintf(fp,"  )\n");
        ...
        //hook up out to in
        {
            ...
            {
                fprintf(fp,"  (segment (start %10.5lf %10.5lf) (end %10.5lf %10.5lf) (width 0.2) (layer B.Cu) )\n",ax,ay,bx,by);
                fprintf(fp,"  (gr_arc (start 150 100) (end %10.5lf %10.5lf) (angle %10.5lf) (layer B.Cu) (width 0.2) )\n",bx,by,zangle);
            }
